...
public class ProfileUIData {
    ...
    public ProfileUIData(String username, String password, String firstName, String lastName, int age, String gender,
    ...
    public ProfileUIData(String firstName, String lastName, int age, String gender, double height,
